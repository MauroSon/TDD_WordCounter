...
TEST_CASE("Teste Cedilha", "[single-file]") {
    CustomDictionary expectedAnswer;
    std::string fileName = {"inputFile6.txt"};

    expectedAnswer.insert("C", 1);
    expectedAnswer.insert("c", 1);
    expectedAnswer.insert("cabeca", 1);
    expectedAnswer.insert("cabeça", 1);
    expectedAnswer.insert("Ç", 1);
    expectedAnswer.insert("ç", 1);
...
TEST_CASE("Teste BreakRow", "[single-file]") {
    ...
    expectedAnswer.insert("três", 1);
    expectedAnswer.insert("um", 1);
...
TEST_CASE("Teste Numeros", "[single-file]") {
    ...
    expectedAnswer.insert("2", 1);
    expectedAnswer.insert("3", 1);
    expectedAnswer.insert("4", 1);
    expectedAnswer.insert("5", 1);
    expectedAnswer.insert("6", 1);
...
TEST_CASE("Teste Quantidade(n+)", "[single-file]") {
    CustomDictionary expectedAnswer;
    std::string fileName = {"inputFile9.txt"};

    expectedAnswer.insert("abacate", 3);
    expectedAnswer.insert("banana", 5);
    expectedAnswer.insert("maçã", 4);
    expectedAnswer.insert("melão", 3);
    expectedAnswer.insert("morango", 6);
